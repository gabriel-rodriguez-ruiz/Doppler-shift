# -*- coding: utf-8 -*-
"""
Created on Fri Feb 27 12:59:35 2026
...
Energies_polar = get_energy_in_polars(radius_values, theta_values, phi_x, phi_y, w_s, w_S,
                           mu_s, mu_S, Delta_s, Delta_S, B_x,
                           B_y, B_x_S, B_y_S, Lambda, w_1[0], q_B_x, q_B_y, q_x, q_y)

Energies_polar = Energies_polar[:, :, 0, 0, 0, 0, 0, 0,:]
